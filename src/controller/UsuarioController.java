...
public class UsuarioController extends HttpServlet {
	...
	protected void processarRequisicao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		}else if(s.equals("listar_plataformas")) {
			listarPlatafor(request, response);
		}
	...
	private void listarPlatafor(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
