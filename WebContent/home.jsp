					...
					<div class="media">
						<div class="media-body">
							...
							<button type="submit" class="btn btn-sm btn-default"
								style="size: 90px">Calcular Deriva</button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="media">
						...
						<div class="media-body">
							...
							<div class="job">Cras justo odio, dapibus ac facilisis in,
								...
								amet risus.</div>
							<button type="submit" class="btn btn-sm btn-default"
								style="size: 90px">Ver dados Climáticos</button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="media">
						<div class="media-body">
							...
							<div class="job">Cras justo odio, dapibus ac facilisis in,
								...
								tortor mauris condimentum nibh, ut fermentum massa justo sit
								amet risus.</div>
							<a class="btn btn-sm btn-default" style="size: 90px;"
								href="UsuarioController?chave=cadastrar_plataformas"
					...
					<div class="media">
						<div class="media-body">
							...
							<div class="job">Cras justo odio, dapibus ac facilisis in,
								...
								amet risus.</div>
							<a class="btn btn-sm btn-default" style="size: 90px;"
								href="UsuarioController?chave=listar_plataformas"
								role="button">Cadastrar Plataformas</a>
						</div>
					</div>
				</div>
