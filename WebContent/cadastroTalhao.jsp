	...
	<div class="container" style="margin-top: 100px">
		<div class="row">
			<form class="form-horizontal"
				action="TalhaoController?chave=iniciar_cadastro_talhao">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="planta" name="tipo" type="planta"
								placeholder="ex: laranja" class="form-control input-md">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
						<input type="submit" value="cadastar talhao"
